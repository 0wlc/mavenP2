		...
		<s:form action="class_update" method="post">
			...
			<table width="80%" align="center">
				<tr>
					...
					<td><s:textfield cssClass="ipt" name="obj.charger"/></td>
				</tr>
				<tr>
					<td></td>
					<td></td>
					...
					<td>
						...
						<input class="btn" type="button" value="返回" onclick="window.open('${_cxt}/class_list.do','_self');" />
					</td>
				</tr>
			</table>
		</s:form>
