...
<body>
<div class="t_in">
	<center><h2>课程新增</h2></center>
	<s:form action="course_add" namespace="/" method="post">
		<table width="80%" align="center">
			<tr>
				<td align="right">授课老师:</td>
				<td>
					<input class="ipt" type="hidden" name="obj.teacherId"/>
					<input class="ipt" type="text" readonly="readonly" name="obj.teacherName"/>
			...
			<tr>
				...
				<td>
					<input class="ipt" type="text" name="obj.credit"/>
				</td>
