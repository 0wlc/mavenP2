...
<body>
<s:form id="f1" action="coursesel_list" method="post">
	<div class="u_search">
		<fieldset>
			<legend>查询条件</legend>
					...
					<tbody valign="middle">
						...
						<tr>
							...
							<td>
								...
								<input class="btn" type="button" value="新增" onclick="location.href='${_cxt }/scourse/add.jsp'"/>
							</td>
						</tr>
					</tbody>	
				</table>
		...
		<fieldset>
			<table class="t_tab">
				...
				<tr align="center">
					...
					<td><a href="${_cxt }/coursesel_update.do?obj.id=${v.id}" target="main">更新</a></td>
					<td><a href="${_cxt }/coursesel_delete.do?obj.id=${v.id}" onclick="return confirm('是否删除?')">删除</a></td>
				</tr>
				</s:iterator>
			</table> 
