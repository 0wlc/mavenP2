...
<script>
	...
	function closeCDialog(result){//关闭窗口
	   ...
	   $("input[name='obj.teacherName']").val(arr[2]); 
	   dialog.close();//关闭窗口
	}
	...
	function closeTDialog(result){//关闭窗口
	   ...
	   $("input[name='obj.className']").val(arr[2]); 
	   dialog.close();//关闭窗口
	}
</script>
</head>
		...
		<s:form action="score_update" method="post">
			...
			<table width="80%" align="center">
				<tr>
					...
					<td><s:textfield cssClass="ipt" name="obj.className" disabled="true"/></td>
				</tr>
				<tr>
					...
					<td><s:textfield cssClass="ipt" name="obj.teacherName" disabled="true"/></td>
				</tr>
				<tr>
					...
					<td>
						...
						<input class="btn" type="button" value="返回" onclick="window.open('${_cxt}/score_list.do','_self');" />
					</td>
				</tr>
			</table>
		</s:form>
